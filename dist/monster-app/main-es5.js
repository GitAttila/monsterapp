...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.router.events
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]; }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["takeUntil"])(this.destroyed$))
            .subscribe(function (navEnd) {
            if (navEnd.url.search('edit') > -1) {
                _this.appSectionName = 'Edit user';
                _this.returnToMainPage = true;
            }
            else if (navEnd.url.search('newuser') > -1) {
                _this.appSectionName = 'Add new user';
                _this.returnToMainPage = true;
            }
            else {
                _this.appSectionName = 'Users';
                _this.returnToMainPage = false;
            }
        });
    };
...
var UserListComponent = /** @class */ (function () {
    function UserListComponent(dataSvc) {
...
var UserComponent = /** @class */ (function () {
    function UserComponent(dataSvc, router, route) {
        this.dataSvc = dataSvc;
        this.router = router;
        this.route = route;
    ...
    UserComponent.prototype.generateAvatar = function (type) {
        type = type || 'fullname';
        var res = '';
        var space = ' ';
        var fn = (this.userForm.get('firstname').value || '');
        var ln = (this.userForm.get('lastname').value || '');
        if (type === 'initials') {
    ...
    UserComponent.prototype.ngOnInit = function () {
        ...
        this.paramSub = this.route.paramMap
            ...
            if (paramMap.has('userId')) {
                ...
                var user = _this.dataSvc.getUserDataById(parseInt(_this.userId, 10));
...
var AuthGuardService = /** @class */ (function () {
    function AuthGuardService(authSvc, router) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.isEnabled = function (params) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            var numOfUsers = _this.dataSvc.getUsersData().length;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getUserDataById = function (id) {
    ...
    DataService.prototype.editUser = function (userId, newUserData) {
        var foundUser = this.userData[userId - 1];
